...
<head>
    ...
    <script type="text/javascript" language="JavaScript">
        ...
        function ajaxget(){
            ...
            mygetrequest.open("GET", "http://localhost:80/SW/ProyectoSW-LB4-AJAX/.back-end/php/ver-preguntas-ajax.php?user="+userId, true);
        ...
        function ajaxgetxml(){
            ...
            var userId = encodeURIComponent(document.getElementById("e-mail").value);
            mygetrequest.open("GET", "http://localhost:80/SW/ProyectoSW-LB4-AJAX/.back-end/php/ver-preguntas-xml-ajax.php?user="+userId, true);
            mygetrequest.send(null);
        ...
        function ajaxgetQuantQuestions(){
            ...
            mygetrequest.open("GET", "http://localhost:80/SW/ProyectoSW-LB4-AJAX/.back-end/php/cantidad-preguntas.php?user="+userId, true);
            mygetrequest.send(null);
        ...
        function ajaxgetQuantityUserIn(){
            ...
            xmlhttp.open("GET", 'http://localhost:80/SW/ProyectoSW-LB4-AJAX/.back-end/xml/contador.xml', true);
            xmlhttp.send();
        }
        ...
        function ajax_user_incr(){
            ...
            var userId = $('#e-mail').val();
            mygetrequest.open("GET", "http://localhost:80/SW/ProyectoSW-LB4-AJAX/.back-end/php/cantidad-visitantes-dentro.php?user="+userId, true);
            mygetrequest.send();
        ...
        function ajaxpost(){
            ...
            mypostrequest.open("POST", "http://localhost:80/SW/ProyectoSW-LB4-AJAX/.back-end/php/insertar-preguntas-ajax.php", true);
...
<div id='page-wrap'>
    <header class='main' id='h1'>
        ...
        <span class="right"><a onclick="alert('Cierre de sesion')" href="../../../.back-end/php/logout.php?user=<?php echo $email;?>">Logout</a></span>
